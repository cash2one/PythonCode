        ...
        for page in range(1):
            ...
            try:
                ...
                for articleblock in soup.findAll('div','article block untagged mb15'):
                    ...
                    content=articleblock.findAll('div','content')[0].text#[0:-2]
                    startI=0
                    for para in content[0:5] :
                        if para=='\n':
                            startI+=1
                    endI=0
                    for para in content[-5::] :
                        if para=='\n':
                            endI+=1

                    content=content[startI:-endI]
                    ...
                    records+=[(qiushi_tagid,content,1)]
...
if __name__ == '__main__':
    ...
    records=main()
    # sql= "INSERT INTO  hifun.test_spider(content_id,content,source_id) value (%s,%s,%s)"
    # print records
    # n = cursor.executemany(sql,records)
    # conn.commit()
